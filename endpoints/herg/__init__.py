...
``Endpoint.herg`` (ADMET-AI's and ADMETlab's hERG pre-screen heads).
...
contribute the same TYPE of signal - some emit a P(block) probability (ADMET-AI, ADMETlab, CardioTox
